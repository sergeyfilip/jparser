...
public:
    ...
    Item(const string& s1,const string& s2,const string& s3):desc(s1),ja3_hash(s2),ja3_string(s3) {}
    Item(const string& s1,const string& s2,const string& s3,const string& s4):desc(s1),ja3_hash(s2),ja3_string(s3),category(s4) {}
